...
>
> Status: **Phase 4 (flights) complete**, awaiting approval to start Phase 5 (buses). Sections 0 and 16 record where things stood when the plan was written and what is still open.
